...
| `http://localhost:5173/` | Тоже оверлей |
...
- **Задачи раунда:** добавление из шаблонов, ручное создание, отметка выполнения
- **Библиотека шаблонов:** 25 PvE/PvP заданий, 16 усложнений (включая авторские от подписчиков Boosty)
- **Усложнения раунда:** выбор для оппонентов
- **Таймер:** пресеты 30с / 1мин / 2мин / 3мин, пауза/сброс
- **Турнирная таблица:** standings по всем участникам
- **Виджет предыдущего игрока**
- **Экспорт/Импорт** состояния турнира в JSON
- **Звуковые эффекты** при смене участника и раунда (Web Audio API)
- **Горячие клавиши:** `↑` / `↓` для переключения между участниками
